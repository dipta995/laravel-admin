...
<div class="form-group">
    ...
    <select name="{{ isset($input['multiple']) ? $input['name'].'[]' : $input['name'] }}" {{ isset($input['required']) ? "required" : "" }} class="form-control simple-selector {{  isset($input['update']) ? $input['name'] : '' }} {{ isset($input['multiple']) ? 'choices multiple-remove' : ''}}" id="{{ isset($input['update']) ? '' : $input['name'] }}" {{ isset($input['multiple']) ? 'multiple' : "" }}>
